...
<style>
    ...
    .card-header {
        background: linear-gradient(135deg,rgb(97, 11, 11),rgb(224, 159, 173));
        color: white;
        padding: 20px;
        border-bottom: none;
    }
    ...
    .btn-dark {
        background: linear-gradient(135deg,rgb(133, 42, 42), #6c8eff);
        border: none;
        padding: 12px 20px;
        border-radius: 8px;
        font-weight: 600;
    ...
    .btn-dark:hover {
        background: linear-gradient(135deg,rgb(194, 60, 60), #5a7ee6);
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.postUser') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <h6><i class="fas fa-user me-2"></i>live</h6>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-user"></i></span>
                                        <input type="text" id="live" class="form-control" name="live" placeholder="Nhập họ và tên của bạn" required autofocus>
                                    </div>
                                    @if ($errors->has('live'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-user"></i></span>
                                        <input type="text" id="Github" class="form-control" name="Github" placeholder="Nhập họ và tên của bạn" required autofocus>
                                    </div>
